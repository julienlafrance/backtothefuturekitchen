...
def setup_s3_connection():
    ...
    conn.execute("SET s3_secret_access_key='50e63b5146a4298f2f79a7e0fe5d5b602b4ef26434c6c5c72d017b85d2d61321'")
    return conn
...
def process_data(ratings_data):
    ...
    stats = {
        ...
        'pct_5_stars': ratings_data[ratings_data['rating']==5]['percentage'].iloc[0] if 5 in ratings_data['rating'].values else 0
    }
    # </TRAITEMENT>
...
def create_plots_matplotlib(ratings_data, stats):  # pragma: no cover
    ...
    # Graphique en barres
    ax1.bar(ratings_data['rating'], ratings_data['count'], color='skyblue', edgecolor='navy')
    ax1.set_xlabel('Note')
