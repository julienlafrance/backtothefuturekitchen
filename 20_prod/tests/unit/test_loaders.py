...
class TestCalculateRatingStats:
    ...
    def test_rating_stats_basic(self):
        ...
        df = pd.DataFrame({"rating": [1, 2, 3, 4, 5], "count": [10, 20, 30, 40, 100]})
    ...
    def test_rating_stats_no_5_stars(self):
        ...
        df = pd.DataFrame({"rating": [1, 2, 3], "count": [30, 40, 30]})
    ...
    def test_rating_stats_average_calculation(self):
        ...
        df = pd.DataFrame({"rating": [1, 5], "count": [50, 50]})
...
class TestFilterValidRatings:
    ...
    def test_filter_valid(self):
        ...
        df = pd.DataFrame(
            {"rating": [-1, 0, 2, 3, 5, 6, 10], "user_id": [1, 2, 3, 4, 5, 6, 7]}
        )
    ...
    def test_filter_custom_column(self):
        ...
        df = pd.DataFrame({"score": [-1, 2, 6], "user_id": [1, 2, 3]})
...
class TestGetTableStats:
    ...
    def test_stats_basic(self):
        ...
        tables_info = [("table1", 1000, 5), ("table2", 2000, 10), ("table3", 3000, 15)]
